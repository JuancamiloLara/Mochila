...
public class Punto3 {
    ...
    public static void main(String[] args) {
        ...
        MochilaNew m_base = new MochilaNew(15, elementos.length);
        MochilaNew m_opt = new MochilaNew(15, elementos.length);
    ...
    public static void llenarMochila(MochilaNew m_base, Elemento[] elementos, boolean llena, MochilaNew m_opt) {
